 ...
 * @author ciclost
 */
@WebServlet(name = "LoginServletPR", urlPatterns = {"/LoginServletPR"})
public class LoginServletPR extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           //cogemos el usuario de la base de datos
            ...
            if(usuario != null) {         
                // Si el login es corecto lo enviamos al index.jsp con su sessión
